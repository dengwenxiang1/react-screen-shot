  ...
  export default class CreateDom {
    ...
    private setBrushSelectPanel (){
      ...
      for( let i=0; i<10; i++){
        ...
        colorItem.appendChild(colorItem);
    ...
    private hiddenAllDom(){
      this.screenShotController.id="none";
      this.toolController.id="none";
      this.optionIcoController.id="none";
      this.optionController.id="none";
      this.cutBoxSizeContainer.id="none";
      this.textInputController.id="none";
    }
